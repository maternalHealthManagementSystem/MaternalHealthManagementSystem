...
const fetchNotifications = async () => {
  ...
  try {
    ...
    try {
      const profileRes = await api.get(`http://172.20.10.4:3000/api/personal_information/${user.user_id}`);
    ...
    const res = await api.get(`http://172.20.10.4:3002/api/notifications/${user.user_id}`, {
...
const openEducation = async (notification) => {
  ...
  try {
    await api.post("http://172.20.10.4:3000/api/read_records", {
